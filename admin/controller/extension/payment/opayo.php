	...
	public function recurringButtons() {
		...
		if (!empty($this->request->get['order_recurring_id'])) {
			...
			if ($order_recurring_info) {
				...
				$data['info_url'] = str_replace('&amp;', '&', $this->url->link('extension/payment/opayo/getRecurringInfo', 'token=' . $this->session->data['token'] . '&order_recurring_id=' . $data['order_recurring_id'], true));
				$data['enable_url'] = str_replace('&amp;', '&', $this->url->link('extension/payment/opayo/enableRecurring', 'token=' . $this->session->data['token'], true));
				$data['disable_url'] = str_replace('&amp;', '&', $this->url->link('extension/payment/opayo/disableRecurring', 'token=' . $this->session->data['token'], true));
