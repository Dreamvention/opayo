...
$('#button-void').click(function() {
	if (confirm('<?php echo $text_confirm_void; ?>')) {
		$.ajax({
			...
			url: 'index.php?route=payment/opayo/void&token=<?php echo $token; ?>',
			beforeSend: function() {
				$('#button-void').hide();
...
$('#button-release').click(function() {
	if (confirm('<?php echo $text_confirm_release; ?>')) {
		$.ajax({
			...
			url: 'index.php?route=payment/opayo/release&token=<?php echo $token; ?>',
			beforeSend: function() {
				$('#button-release').hide();
				$('#release-amount').hide();
...
$('#button-rebate').click(function() {
	if (confirm('<?php echo $text_confirm_rebate; ?>')) {
		$.ajax({
			...
			url: 'index.php?route=payment/opayo/rebate&token=<?php echo $token; ?>',
			beforeSend: function() {
				$('#button-rebate').hide();
				$('#rebate-amount').hide();
