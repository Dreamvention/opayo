<?php
class ControllerRecurringOpayo extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (!empty($this->request->get['order_recurring_id'])) {
			$this->load->language('recurring/opayo');
			...
			if ($order_recurring_info) {
				...
				$data['info_url'] =  str_replace('&amp;', '&', $this->url->link('recurring/opayo/getRecurringInfo', 'order_recurring_id=' . $data['order_recurring_id'], true));
				$data['enable_url'] =  str_replace('&amp;', '&', $this->url->link('recurring/opayo/enableRecurring', '', true));
				$data['disable_url'] =  str_replace('&amp;', '&', $this->url->link('recurring/opayo/disableRecurring', '', true));
				
				$content = $this->load->view('recurring/opayo', $data);
			}
		}
